...
const players: Player[] = [
  { id: 1, initials: "AS", color: "#1a3a5c", name: "Abdelmalek Smaili", email: "abdelmalek.smaili@gmail.com", category: "Minime", poste: "Latéral gauche", dob: "5 juil. 2010", number: 3 },
  { id: 2, initials: null, color: null, name: "Achref El Ghoul", email: "achref@gmail.com", category: "—", poste: "Ailier", dob: "26 juil. 1994" },
  { id: 3, initials: "AB", color: "#1a3d2e", name: "Adem Bougdiri", email: "adem.bougdiri@gmail.com", category: "Minime", poste: "Latéral gauche", dob: "14 janv. 2010", number: 7 },
  ...
  { id: 5, initials: "AB", color: "#252545", name: "Ahmed Boutar", email: "ahmed.boutar@gmail.com", category: "École A", poste: "Milieu défensif central", dob: "9 août 2012", number: 14 },
  ...
  { id: 7, initials: "BT", color: "#3a1a1a", name: "Bilel Trabelsi", email: "bilel.trabelsi@gmail.com", category: "Senior", poste: "Gardien de but", dob: "12 mars 1998", number: 1 },
  { id: 8, initials: "KM", color: "#4a1a1a", name: "Karim Mansour", email: "karim.mansour@gmail.com", category: "Junior", poste: "Défenseur central", dob: "3 juin 2005", number: 5 },
];

/* ─── Category badge config ─── */
const categoryStyle: Record<string, string> = {
  Senior:   "bg-brand-600/[0.10] text-brand-600",
  Junior:   "bg-success-50 text-success-600",
  Minime:   "bg-warning-50 text-warning-600",
  "École A": "bg-special-colors-1000 text-special-colors-900",
};
...
export default function JoueursPage() {
  ...
  const someSelected = selected.length > 0 && selected.length < players.length;
    ...
    <div className="bg-neutral-0 min-h-screen w-full font-sans flex flex-col">
      ...
      <div className="px-9 pt-8 pb-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-caption text-neutral-400 mt-0.5">
                ...
                {" "}joueur{filtered.length !== 1 ? "s" : ""} au total
              </p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 mb-6 flex-wrap">
          ...
          <FilterPill label="Toutes les catégories" />
          <FilterPill label="Toutes les positions" />
          <FilterPill label="Année de naissance" />
        ...
        <div className="rounded-lg overflow-hidden border border-neutral-200 bg-neutral-50 shadow-[0_8px_40px_rgba(0,0,0,0.45)]">
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-5">
              ...
              <p className="text-body text-neutral-500">Aucun joueur trouvé</p>
